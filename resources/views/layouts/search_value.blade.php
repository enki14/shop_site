    ...
    <div class="row justify-content-center">
        <form method="post" action="result" id="search-form">
            ...
            <div class="form-content form-group form-inline">
                ...
                <input type="text" id="search-shop" name="search-shop" class="search-shop form-control input-lg border-success mr-3" 
                value="{{ $shop }}" placeholder="店名・地域など" aria-label="店名・地域検索" />
                <input type="submit" id="kensaku-main" class="kensaku-btn btn fas" 
                value="&#xf002; 検索" data-toggle="popover" />
            </div>
        </form>
    </div>
</div>
