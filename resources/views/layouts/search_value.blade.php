    ...
    <div class="row justify-content-center">
        <form method="post" action="result" id="search-form">
            ...
            <div class="form-content form-group form-inline">
                ...
                style="width: 170px; height: 60px;" aria-label="Default select example">
                ...
                value="{{ $shop }}" placeholder="店名・地域など" aria-label="店名・地域検索" style="width: 350px; height: 60px;" />
                <input type="submit" id="kensaku-main" class="kensaku-btn btn fas" 
                value="&#xf002; 検索" data-toggle="popover" style="width: 150px; height: 55px;" />
            </div>
        </form>
    </div>
</div>
